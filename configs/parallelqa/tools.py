...
def generate_tools(args, model_name):
    """Generate tools for parallelqa benchmark.

    Unlike the static `tools` variable, this function creates tools
    that require model_name for the math chain.
    """
...
# Keep backward compatibility with static tools (search only)
tools = [
    Tool(
        name="search",
        func=docstore.asearch,
